...
lint:
	...
	pylint --output-format=parseable src/ska/ska_python_skeleton | tee ./build/code_analysis.stdout; \
	pylint --output-format=pylint2junit.JunitReporter src/ska/ska_python_skeleton > ./build/reports/linting.xml;
